...
import { Zap, Shield, BarChart3, Settings2, ArrowRight, Phone, Mail, CheckCircle2 } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-24 reveal-container">
          ...
          <div className="flex flex-wrap gap-4 justify-center mt-10 reveal-item">
            ...
            <MagneticButton>
              <a href="tel:08000430609" className="px-8 py-4 rounded-xl font-bold text-base text-white border border-white/20 hover:bg-white/10 transition-colors inline-flex items-center gap-2">
                <Phone size={18} /> 0800 043 0609
              </a>
            </MagneticButton>
          </div>
        </div>
        ...
        <div className="w-full max-w-4xl mx-auto mb-32 reveal-container">
          <div className="reveal-item w-full h-64 md:h-96 rounded-3xl bg-[#1A1D22] border border-white/5 border-dashed flex flex-col items-center justify-center text-white/20 text-sm font-mono">
            {/* Replace this div with an <img> when remap photos are available */}
            <Settings2 size={48} strokeWidth={1} className="mb-4 text-white/10" />
            <span>[ Remap image placeholder ]</span>
            <span className="text-xs mt-1">Replace with ECU / dyno / laptop-on-car photo</span>
          </div>
        </div>
                ...
                <ul className="relative z-10 space-y-3">
                  {stage.highlights.map((h, idx) => (
                    <li key={idx} className="flex items-start text-white/70 text-sm font-medium">
                      <div className="w-1.5 h-1.5 bg-[#FF7A00] rounded-full mr-3 mt-1.5 shadow-[0_0_10px_rgba(255,122,0,0.5)] shrink-0"></div>
                      {h}
                    </li>
                  ))}
                </ul>
        ...
        {/* Placeholder image slot 2 */}
        <div className="w-full max-w-4xl mx-auto mb-32 reveal-container">
          <div className="reveal-item w-full h-48 md:h-64 rounded-3xl bg-[#1A1D22] border border-white/5 border-dashed flex flex-col items-center justify-center text-white/20 text-sm font-mono">
            <BarChart3 size={40} strokeWidth={1} className="mb-3 text-white/10" />
            <span>[ Before / after dyno graph placeholder ]</span>
          </div>
        </div>
