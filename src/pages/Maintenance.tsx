...
const Maintenance = () => {
  ...
  return (
    <div ref={container} className="pt-32 pb-24 bg-[#0A0A0A] min-h-screen relative overflow-hidden">
      <SEO title="DPF Maintenance Guide | AutoCleanse Devon" description="Expert DPF maintenance advice for Devon drivers. Annual cleaning prevents limp mode, DPF warning lights, and costly replacements. Tips from AutoCleanse." path="/maintenance" />
