  ...
  return (
    <div ref={container} className="pt-32 pb-24 bg-[#0A0A0A] min-h-screen relative overflow-hidden">
      <SEO
        ...
        description="Professional DPF cleaning near Newton Abbot — just 8 miles from our Totnes workshop. We collect, clean to 98% efficiency and return, often same day. Cars, vans, HGVs & fleets."
        ...
        <div className="text-center mb-20 reveal-container">
          ...
          <div className="max-w-4xl mx-auto reveal-item">
            <p className="text-xl md:text-2xl text-white/50 leading-relaxed font-medium">
              ...
              workshop is just 8 miles away. We collect, deep-clean your filter to factory flow rates, and
