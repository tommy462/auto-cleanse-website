  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed bottom-24 right-6 lg:bottom-6 w-14 h-14 gradient-orange rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 z-40 ${
